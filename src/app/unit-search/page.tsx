import { UnitSearchComponent } from '@/components/UnitSearchComponent';
        ...
        <div className="mt-8 p-6 bg-white border border-slate-200 rounded-lg shadow-sm">
          ...
          <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <p className="text-blue-800 text-sm">
              Each Unit record includes related data such as ViewConfigs, UnitVariant (with Exteriors, Floors, Interiors),
              and PropertyFloor hierarchy (Property, Cluster, Project, City, Nation).
            </p>
          </div>
        </div>
      </div>
